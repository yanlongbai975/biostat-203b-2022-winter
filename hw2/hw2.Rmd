...
```{r}
system.time(read.csv("/Users/a123456/biostat-203b-2022-winter/1.0/core/admissions.csv.gz"))
system.time(read_csv("/Users/a123456/biostat-203b-2022-winter/1.0/core/admissions.csv.gz"))
system.time(fread("/Users/a123456/biostat-203b-2022-winter/1.0/core/admissions.csv.gz"))
```
...
```{r}
icustays_tble = read_csv("/Users/a123456/biostat-203b-2022-winter/1.0/icu/icustays.csv.gz")
```
...
The result indicates that there are only 53150 unique `subject_id`s, which is much less than the total number.
...
```{r}
admissions_tble = read_csv("/Users/a123456/biostat-203b-2022-winter/1.0/core/admissions.csv.gz")
```
...
icustays_tble = arrange(icustays_tble, subject_id, intime) %>%
  distinct(subject_id, .keep_all = TRUE)
patients_tble = read_csv("/Users/a123456/biostat-203b-2022-winter/1.0/core/patients.csv.gz")
...
```{bash}
gzip -cd "/Users/a123456/biostat-203b-2022-winter/1.0/hosp/labevents.csv.gz" | wc -l
```
...
```{r, eval=FALSE}
labevents_tble = read_csv("/Users/a123456/biostat-203b-2022-winter/1.0/hosp/labevents_filtered_itemid.csv.gz")
...
```{r, eval=FALSE}
icustays_tble = read_csv("/Users/a123456/biostat-203b-2022-winter/1.0/icu/icustays.csv.gz")
chartevents_tble = read_csv("/Users/a123456/biostat-203b-2022-winter/1.0/icu/chartevents_filtered_itemid.csv.gz")
...
mimic_icu_cohort = mimic_icu_cohort[-c(36:38)] #delete all intermediate columns that used to obtain column "thirty_day_mort".
```
