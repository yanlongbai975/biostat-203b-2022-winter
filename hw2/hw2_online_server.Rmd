---
title: "Biostat 203B Homework 2 Online Server"
...
```{r}
system.time(read_csv("/mnt/mimiciv/1.0/core/admissions.csv.gz", show_col_types = FALSE))
```
...
```{r}
icustays_tble = read_csv("/mnt/mimiciv/1.0/icu/icustays.csv.gz", show_col_types = FALSE)
icustays_tble
```
...
```{r}
admissions_tble = read_csv("/mnt/mimiciv/1.0/core/admissions.csv.gz", show_col_types = FALSE)
admissions_tble
```
...
```{r, eval=FALSE}
# This is a cycle written by my own for this question, it also works but costs much more time, so I choose to use methods from dplyr.
labevents_tble = read_csv("/mnt/mimiciv/1.0/hosp/labevents_filtered_itemid.csv.gz")
...
lab_mes = read_csv("/mnt/mimiciv/1.0/hosp/d_labitems.csv.gz", col_select = c(1), show_col_types = FALSE) %>%
  filter(itemid %in% interest_lab_mes)
labevents_tble = read_csv("/mnt/mimiciv/1.0/hosp/labevents_filtered_itemid.csv.gz", show_col_types = FALSE) %>%
...
vit = read_csv( "/mnt/mimiciv/1.0/icu/d_items.csv.gz", col_select = c(1), show_col_types = FALSE) %>%
  filter(itemid %in% interest_vit)
chartevents_tble = read_csv("/mnt/mimiciv/1.0/icu/chartevents_filtered_itemid.csv.gz", show_col_types = FALSE) %>%
